...
const formSchema = z.object({
  image: z.any().refine((file) => !!file, "Image or Music File is required."),
  name: z
    ...
    <div className="max-w-xl mx-auto">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <div className="rounded-2xl bg-white flex flex-col gap-5 p-5 mb-5">
            {/* image */}
            <FormField
              control={form.control}
              name="image"
                ...
                <FormItem className="w-full max-w-[240px]">
                  ...
                  <AspectRatio ratio={1 / 1}>
                    <Uploader
                      ...
                      onExceedFileSize={() => form.setError("image", { message: "Max file size is 20MB" })}
            ...
            <FormField
              ...
              render={({ field, fieldState }) => (
                <FormItem>
                  ...
                  <FormMessage />
                  <FormDescription>
                    URI pointing to an external URL defining the asset — e.g. the asset&apos;s community site.
                  </FormDescription>
                </FormItem>
              )}
            />
